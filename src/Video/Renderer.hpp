...
namespace Video {
    ...
    class Renderer {
        public:
             ...
             * @param isSelected Whether model is selected(should be highlighted) or not.
             */
            void RenderSkinnedMesh(Geometry::Geometry3D* geometry, const Texture2D* albedo, const Texture2D* normal, const Texture2D* metallic, const Texture2D* roughness, const glm::mat4 modelMatrix, const std::vector<glm::mat4>& bones, bool isSelected);
