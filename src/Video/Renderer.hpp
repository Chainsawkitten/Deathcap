...
namespace Video {
    ...
    class Renderer {
        public:
             ...
             */
            VIDEO_API void SetFogDensity(bool fogDensity);
             ...
             */
            VIDEO_API void SetFogColor(glm::vec3 fogColor);
             ...
             */
            VIDEO_API void SetColorFilterColor(glm::vec3 colorFilterColor);
             ...
             */
            VIDEO_API void SetFrameSize(glm::vec2 frameSize);
