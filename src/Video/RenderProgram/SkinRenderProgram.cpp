...
//void Video::SkinRenderProgram::PreShadowRender(const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix, int shadowId, int shadowWidth, int shadowHeight, int depthFbo) {
...
//    this->viewProjectionMatrix = projectionMatrix * viewMatrix;
//
//    glUniformMatrix4fv(SkinRenderProgram->GetUniformLocation("viewProjection"), 1, GL_FALSE, &viewProjectionMatrix[0][0]);
//}

//void Video::SkinRenderProgram::DepthRender(Geometry::Geometry3D* geometry, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix, const glm::mat4& modelMatrix) const {
...
//void Video::SkinRenderProgram::ShadowRender(Geometry::Geometry3D* geometry, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix, const glm::mat4& modelMatrix) const {
//    Frustum frustum(viewProjectionMatrix * modelMatrix);
//    if (frustum.Collide(geometry->GetAxisAlignedBoundingBox())) {
//        glBindVertexArray(geometry->GetVertexArray());
//
