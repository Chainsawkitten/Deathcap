...
class VRManager {
    ...
    public:
         ...
         */
        ENGINE_EXPORT glm::mat4 GetControllerPoseMatrix(int controlID) const;
         ...
         */
        ENGINE_EXPORT glm::mat4 GetHMDEyeToHeadMatrix(vr::Hmd_Eye eye) const;
         ...
         */
        ENGINE_EXPORT glm::mat4 GetHMDProjectionMatrix(vr::Hmd_Eye eye, float zNear, float zFar) const;
         ...
         */
        ENGINE_EXPORT void Submit(vr::Hmd_Eye eye, vr::Texture_t* texture) const;

        /// Get scale of player.
        /**
         * @return Scale to get.
         */
        ENGINE_EXPORT float GetScale() const;

        /// Set scale of player.
        /**
         * @param scale Scale to set.
         */
        ENGINE_EXPORT void SetScale(float scale);
         ...
         */
        ENGINE_EXPORT bool GetInput(vr::EVRButtonId buttonID);
