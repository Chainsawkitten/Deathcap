...
class ResourceManager {
    ...
    public:
        ...
        */
        ENGINE_EXPORT Geometry::Model* CreateModel(const std::string& name);

        /// Free the reference to the model.
        /**
        * @param model %Model to dereference.
        */
        ENGINE_EXPORT void FreeModel(Geometry::Model* model);
         ...
         */
        ENGINE_EXPORT Video::Texture2D* CreateTexture2D(const char* data, int dataLength, bool srgb = false);
         ...
         */
        ENGINE_EXPORT void FreeTexture2D(Video::Texture2D* texture);
         ...
         */
        ENGINE_EXPORT TextureAsset* CreateTextureAsset(const std::string& name);
         ...
         */
        ENGINE_EXPORT void FreeTextureAsset(TextureAsset* textureAsset);
         ...
         */
        ENGINE_EXPORT int GetTextureAssetInstanceCount(TextureAsset* textureAsset);
         ...
         */
        ENGINE_EXPORT Audio::SoundBuffer* CreateSound(const std::string& name);
         ...
         */
        ENGINE_EXPORT void FreeSound(Audio::SoundBuffer* soundBuffer);
         ...
         */
        ENGINE_EXPORT ScriptFile* CreateScriptFile(const std::string& name);
         ...
         */
        ENGINE_EXPORT void FreeScriptFile(ScriptFile* scriptFile);
