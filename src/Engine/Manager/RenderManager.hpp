...
class RenderManager {
    ...
    private:
        ...
        void Render(World& world, const glm::vec3& position, const glm::mat4& translationMatrix, const glm::mat4& orientationMatrix, const glm::mat4& projectionMatrix, Video::RenderSurface* renderSurface);
