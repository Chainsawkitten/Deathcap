...
#ifdef _WIN32
#ifdef miniz_EXPORTS
#define MINIZ_API __declspec(dllexport)
#else
#define MINIZ_API __declspec(dllimport)
#endif
#else
#define MINIZ_API
#endif
...
MINIZ_API int mz_compress(unsigned char *pDest, mz_ulong *pDest_len, const unsigned char *pSource, mz_ulong source_len);
int mz_compress2(unsigned char *pDest, mz_ulong *pDest_len, const unsigned char *pSource, mz_ulong source_len, int level);

/* mz_compressBound() returns a (very) conservative upper bound on the amount of data that could be generated by calling mz_compress(). */
MINIZ_API mz_ulong mz_compressBound(mz_ulong source_len);
...
MINIZ_API int mz_uncompress(unsigned char *pDest, mz_ulong *pDest_len, const unsigned char *pSource, mz_ulong source_len);
